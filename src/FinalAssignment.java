...
public class FinalAssignment {
	...
	static int NUMBER_OF_USERS2 = 1000;
	static int NUMBER_OF_USERS = 686;
	static int NUMBER_OF_PRODUCTS = 100;
	
	static String MOST_REVIEWED = "Books-" + NUMBER_OF_PRODUCTS + "-most-reviewed.txt";
	
	static String MOST_REVIEWED_AND_MOST_ACTIVE = "Books-" + NUMBER_OF_PRODUCTS + "-most-reviewed-" + NUMBER_OF_USERS2 + "-most-active-users.txt";
	
	static String MOST_REVIEWED_AND_MOST_ACTIVE_WITH_INTEGER_IDS = "Books-" + NUMBER_OF_PRODUCTS + "-most-reviewed-" + NUMBER_OF_USERS2 + "-most-active-users-Integer-IDS.txt";
	...
	public static void runPreprocessor() {
		...
		//Preprocessor.createFileWithOnlyKRandomProducts(NUMBER_OF_PRODUCTS, BASE_PATH, "Books-tab-delim.txt", MOST_REVIEWED);
		//Preprocessor.createFileWithOnlyKMostActiveUsers(NUMBER_OF_USERS, BASE_PATH, "Books-tab-delim.txt", MOST_REVIEWED_AND_MOST_ACTIVE);
		Preprocessor.createFileWithOnlyKMostReviewedProducts(NUMBER_OF_PRODUCTS, BASE_PATH, MOST_REVIEWED_AND_MOST_ACTIVE, MOST_REVIEWED);
		Preprocessor.integerizeUserAndProductIds(BASE_PATH, MOST_REVIEWED, MOST_REVIEWED_AND_MOST_ACTIVE_WITH_INTEGER_IDS);
	}
